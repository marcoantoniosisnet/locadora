	...
	<div id="geral">
		...
		<form method="post"	action="<%=request.getContextPath()%>/cliente/FilmeCRUD"
						...
						<table  border="1">
								<thead>
						<tr>
							<td><img  src="/WebInterLocadora/resources/imgVid/vd5.jpg"  height="180" width="150"/></td>
							<td><img  src="/WebInterLocadora/resources/imgVid/vd6.jpg"  height="180" width="150"/></td> 
							<td><img  src="/WebInterLocadora/resources/imgVid/vd4.jpg"  height="180" width="150"/></td> 
						</tr>
						
						<tr>
							<td><img  src="/WebInterLocadora/resources/imgVid/vd3.jpg"  height="180" width="150"/></td>
							<td><img  src="/WebInterLocadora/resources/imgVid/vd1.jpg"  height="180" width="150" /></td> 
							<td><img  src="/WebInterLocadora/resources/imgVid/vd2.jpg"  height="180" width="150" /></td>
						</tr>
